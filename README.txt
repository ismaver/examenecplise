...
a persistence unit "ExamenVerdugoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenVerdugo/pom.xml":
...
artifact ("ExamenVerdugo.war") is already built. You can build
